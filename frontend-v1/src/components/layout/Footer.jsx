  ...
  const sections = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Restaurant Dashboard', href: '/restaurant-admin/login' },
        { name: 'Delivery Dashboard', href: '/delivery/login' },
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="xl:grid xl:grid-cols-4 xl:gap-8">
          ...
          <div className="space-y-8 xl:col-span-1">
            ...
            <p className="text-gray-500 text-base">
              Making food delivery seamless, fast, and delightful for everyone.
            </p>
        ...
        <div className="mt-12 border-t border-gray-200 pt-8">
          <p className="text-base text-gray-400 xl:text-center">
            &copy; {currentYear} Food Express, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
