   ...
   try {
    ...
    if (orderResponse.status === 201) {
      ...
      const deliveryBody = {
        ...
        pickupAddress: `${restaurantData.name}, ${restaurantId}`, // Example pickup address
        deliveryAddress: deliveryAddress || "No 6, Siripala Road, Dehiwala", // Example delivery address
      ...
      if (deliveryResponse.status === 201) {
        ...
        const paymentBody = {
          amount: Math.round(parseFloat(orderTotal.toFixed(2)) * 100), // 6430 cents
          quantity: items.length, // total quantity of items
          currency: 'USD',
          name: 'Total Bill', // You can customize this as needed
        };
