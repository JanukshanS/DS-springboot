...
import ChatBot from '../components/common/ChatBotComponenet';
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 bg-orange-500 text-white p-4 rounded-full shadow-lg z-50 hover:bg-orange-600 transition"
      >
        💬
      </button>
     ...
     {/* Chatbot Overlay */}
{showChatBot && (
  <div className="fixed inset-0 bg-transparent bg-opacity-30 backdrop-blur-sm flex justify-end items-end md:items-center z-50 p-4 md:p-0">
    {/* Close button (X icon) */}
    <button 
    ...
    {/* Chatbot container */}
    <div 
      className="bg-white rounded-xl shadow-xl w-full max-w-md h-[80vh] max-h-[700px] flex flex-col overflow-hidden border border-gray-200"
    ...
    >
      ...
      <div className="bg-gradient-to-r from-orange-500 to-orange-600 text-white p-4 flex items-center">
        ...
        <div>
          <h3 className="font-semibold text-lg">FoodExpress Assistant</h3>
