...
import { fetchRestaurants, setFilters, clearFilters, setPage } from '../store/slices/restaurantSlice';
            ...
            <>
              {restaurants.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  {(Object.values(filters).some(value => value !== null) || searchTerm) && (
                    <Button
                      variant="outline"
                      className="mt-4"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {restaurants.map((restaurant) => {
                    ...
                    const mappedRestaurant = {
                      ...restaurant,
                      cuisine: restaurant.cuisineType || restaurant.cuisine || 'Various',
                      ...
                      >
                        <div className="h-48 bg-gray-200 relative">
                          {restaurant.imageUrl ? (
                            ...
                            <div className="w-full h-full flex items-center justify-center bg-gradient-to-r from-orange-400 to-orange-500 text-white">
                              <span className="text-2xl font-semibold">{restaurant.name.charAt(0)}</span>
                            </div>
                          )}
                          <div className="absolute top-4 left-4 bg-orange-500 text-white text-sm py-1 px-3 rounded-full">
                            {mappedRestaurant.rating} <FiStar className="inline-block ml-1" />
                          </div>
                        </div>
                        ...
                        <div className="p-6">
                          ...
                          <div className="flex items-center text-gray-500 text-sm mb-4">
                            <span className="mr-2">{mappedRestaurant.cuisine}</span>
                            <span>•</span>
                            <span className="mx-2">
